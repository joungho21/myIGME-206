...
namespace PE9Q2
{
    ...
    {
        // PE9 Q3
        // Author: David Schuh, Edited further by Joungho Seo
        // Purpose: Implemented 5s timer 
        // Restrictions: does not stop user from inputting after 5s, just checks if it exceeded more than 5s.
        static void Main()
        {
            // store user name
            string myName = "";
            ...
            double elapsedMs; //to count milisecond
        ...
        start:
            ...
            for (nCntr = 0; nCntr < nQuestions; ++nCntr)
            {
                ...
                do
                {
                    ...
                    var watch = System.Diagnostics.Stopwatch.StartNew(); //start stop watch
                    sResponse = Console.ReadLine();
                    watch.Stop(); //stop the clock
                    elapsedMs = watch.ElapsedMilliseconds; //elapse time in milliseconds
                ...
                if (nResponse == nAnswer && elapsedMs<5000) //check if the answer took less than 5s
                {
                ...
                else if(elapsedMs > 5000){ //Check if the answer took more than 5s
                    Console.BackgroundColor = ConsoleColor.Black;
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("I'm sorry {0}. You took longer than 5s. The answer is {1}", myName, nAnswer);
                }
                else
                {
                    Console.BackgroundColor = ConsoleColor.Black;
